        ...
        <main>
            <div class="container-lg p-3">
                <div class="border p-4 h-100">
                    <h2>Thank you. Your story is deleted successfully</h2>
                    <form method="get" action="view-story">
                        <% 
                            String email = (String) session.getAttribute("mail");
                        %>
                        <input type="text" hidden id="mail" name="mail" value="<% out.println(email); %>">
                        <button type="submit" class="btn btn-primary">View story</button>
                    </form>
                </div>
            </div>
        </main>
